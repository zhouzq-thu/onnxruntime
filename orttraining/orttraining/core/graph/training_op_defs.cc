...
Return true if all elements are true and false otherwise.
  ...
  ONNX_CONTRIB_OPERATOR_SCHEMA(PythonOp)
      ...
      .Attr(
          "tensor_reuse_map",
          "A int array indicating whether output at each index are reusing specific input or now."
          "If the given index is -1, it means the output is not reusing any input."
          "For example, there are 2 inputs and 3 outputs, tensor_reuse_map = [-1, 1, 0] means"
      ...
      .Attr(
          ...
          "A int array indicating whether output at each index are reusing specific input or now."
          "If the given index is -1, it means the output is not reusing any input."
          "For example, there are 2 inputs and 3 outputs, bw_tensor_reuse_map = [-1, 1, 0] means"
          "- the output 0 (ctx) don't reuse any input buffer."
          "- the output 1 reuses the input 1."
          "- the output 2 reuses the input 0.",
          AttributeProto::INTS,
  ...
  ONNX_CONTRIB_OPERATOR_SCHEMA(PythonOpGrad)
      ...
      .Attr(
          ...
          "A int array indicating whether output at each index are reusing specific input or now."
          "If the given index is -1, it means the output is not reusing any input."
          "For example, there are 3 inputs and 2 outputs, tensor_reuse_map = [2, 1] means"
