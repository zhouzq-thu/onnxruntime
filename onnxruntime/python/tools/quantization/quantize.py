        ...
        extra_options:
            key value pair dictionary for various options in different case. Current used:
                ...
                QuantMinRealRange = float|None :
                    ...
                    is less than the specified minimum range, rmax will be set to rmin + QuantMinRealRange. Additionally,
                    "tiny" scale values will no longer be overridden to 1.0. This is necessary for EPs like QNN that
                    require a minimum floating-point range when determining quantization parameters.
    """
